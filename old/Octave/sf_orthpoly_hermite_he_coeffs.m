## -*- texinfo -*-
## @deftypefn {Function File} {@var{res} =} sf_orthpoly_hermite_he_coeffs (@var{n})
## Compute the coefficients of the $n$'th Hermite polynomial:
## $He_n(z) = a_1 + a_2*x + ... + a_(n+1)*x^n$,
## $n=0, 1, 2, ...$
## @end deftypefn

function res = sf_orthpoly_hermite_he_coeffs(n)
