## -*- texinfo -*-
## @deftypefn {Function File} {@var{res} =} sf_bessel_spher_i2 (@var{n}, @var{z})
## Compute spherical Bessel i^(2)_n(z) function
## @end deftypefn

function res = sf_bessel_spher_i2(n, z)
