...
// TODO: add rounding modes & max # read...
pub fn parse_hex_f64s(s:&str) -> Vec<f64> {
  let digits;
  let exp : isize;
...
pub fn parse_bytes_f64(bytes:&[u8], exp:isize, start:usize) -> (f64,usize) {
...
pub fn string_to_bytes(s:&str) -> (Vec<u8>,usize) {
