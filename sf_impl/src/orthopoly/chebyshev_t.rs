...
impl<V: Value> OrthogonalPolynomial<V> for ChebyshevT<V> {
  ...
  fn weight(&self, n: usize, k: usize) -> V { unimplemented!() }
  fn zero(&self, n: usize, k: usize) -> V { unimplemented!() }
  ...
  fn weights(&self, n: usize) -> Vec<V> { unimplemented!() }
  fn zeros(&self, n: usize) -> Vec<V> { unimplemented!() }
