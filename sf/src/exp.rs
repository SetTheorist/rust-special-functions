...
impl SFExp for f64 {
  ...
  #[inline] fn sf_exp_m1(self) -> Self { exp::sf_exp_m1(r64(self)).0 }
  #[inline] fn sf_exp_m1vx(self) -> Self { exp::sf_exp_m1vx(r64(self)).0 }
  #[inline] fn sf_expn(self, n:isize) -> Self { exp::sf_expn(n, r64(self)).0 }
  #[inline] fn sf_exp_men(self, n:isize) -> Self { exp::sf_exp_men(n, r64(self)).0 }
  #[inline] fn sf_exp_menx(self, n:isize) -> Self { exp::sf_exp_menx(n, r64(self)).0 }
}


impl SFExp for num_complex::Complex<f64> {
  #[inline] fn sf_exp(self) -> Self { t(exp::sf_exp(f(self))) }
  #[inline] fn sf_exp_m1(self) -> Self { t(exp::sf_exp_m1(f(self))) }
  #[inline] fn sf_exp_m1vx(self) -> Self { t(exp::sf_exp_m1vx(f(self))) }
  #[inline] fn sf_expn(self, n:isize) -> Self { t(exp::sf_expn(n, f(self))) }
  #[inline] fn sf_exp_men(self, n:isize) -> Self { t(exp::sf_exp_men(n, f(self))) }
  #[inline] fn sf_exp_menx(self, n:isize) -> Self { t(exp::sf_exp_menx(n, f(self))) }
}
